...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#masterfiles"
                    aria-expanded="true" aria-controls="masterfiles">
                    <i class="fas fa-folder"></i>
                    <span>Master files</span>
                </a>
                <div id="masterfiles" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="#" onclick="document.getElementById('loginForm').submit();">Logout</a>
